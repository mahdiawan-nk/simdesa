...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-4">
        ...
        <div class="card-body row justify-content-center">
            <form action="<?= base_url('panel-admin/halaman/save') ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title_halaman">
                </div>
                <div class="form-group">
                    <label for="">Slugs Halaman</label>
                    <input type="text" class="form-control" readonly name="slug_name">
                </div>
                <div class="form-group">
                    <label for="">Template Halaman</label>
                    <select name="template" id="" class="form-control">
                        <option value="">Pilih Template</option>
                        <option value="row_text">Row text</option>
                        <option value="card_profil">Card Profil</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-check">
                            <input name="is_statics" class="form-check-input" type="radio" value="Y" id="defaultRadio1" required>
                            <label class="form-check-label" for="defaultRadio1"> Yes </label>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-check">
                            <input name="is_statics" class="form-check-input" type="radio" value="N" id="defaultRadio1" required>
                ...
                <div class="form-group" id="isi-halaman">
                    ...
                    <textarea name="isi_halaman" id="summernote" cols="30" rows="10"></textarea>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input name="redirect" class="form-check-input" type="radio" value="Y" id="defaultRadio1" required>
                                <label class="form-check-label" for="defaultRadio1"> Yes </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-check">
                                <input name="redirect" class="form-check-input" type="radio" value="N" id="defaultRadio1" required>
                                <label class="form-check-label" for="defaultRadio1"> No </label>
                            </div>
                        </div>
                    </div>

                    <input type="text" class="form-control" name="link_redirect" readonly value="<?= base_url('panel-admin/pengajuan-surat') ?>">
    ...
    $(function() {
        ...
        $('#summernote').summernote({
            ...
            toolbar: [
                ...
                ['insert', ['link', 'picture', 'customButton']],
                ['table', ['table']],
