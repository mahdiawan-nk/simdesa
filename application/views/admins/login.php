            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?=base_url('userauth/checklogin')?>" method="POST">
                            <div class="mb-3">
                                <label for="email" class="form-label">NIK</label>
                                <input type="text" class="form-control" id="email" name="nikuser" placeholder="Enter your NIK" autofocus />
                            </div>
