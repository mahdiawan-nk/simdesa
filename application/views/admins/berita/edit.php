...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="<?= base_url('panel-admin/berita/update/' . $news->id) ?>" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="slugs" readonly value="<?= $news->slug ?>">
                </div>
                <div class="mb-3">
                    ...
                    <img src="<?= base_url('assets/uploads/berita/' . $news->thumbnail) ?>" alt="No Imgaes Uploaded" id="preview" class="mx-auto d-block img-thumbnail w-25">
                    <div class="divider">
                        <div class="divider-text">Preview Image</div>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-start">
                        <div class="m-2 form-check">
                            <input class="form-check-input" type="radio" name="status" id="flexRadioDefault1" value="active" <?= $news->status == 'active' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="flexRadioDefault1">
                                Active
                            </label>
                        </div>
                        <div class="m-2 form-check">
                            <input class="form-check-input" type="radio" name="status" id="flexRadioDefault1" value="suspend" <?= $news->status == 'suspend' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="flexRadioDefault1">
                                Draft/suspend
                            </label>
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="kategori_id" id="" class="form-control">
                        ...
                        <?php foreach ($kategori as $item) : ?>
                            <option value="<?= $item->id_kategori ?>" <?= $news->kategori_id == $item->id_kategori ? 'selected' : '' ?>><?= $item->nama_kategori ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="basic-default-fullname">Content</label>
                    <textarea name="content" class="form-control" id="summernote" cols="30" rows="10"><?= $news->content ?></textarea>
                </div>
            ...
            callbacks: {
                ...
                onKeydown: function(e) {
                    ...
                    if (e.keyCode === 9) {
                        ...
                        // Insert four spaces when the Tab key is pressed
