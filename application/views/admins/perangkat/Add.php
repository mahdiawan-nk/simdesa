...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-4">
        ...
        <div class="card-body row justify-content-center">
            <div class="col-sm-6 ">
                <form method="post" action="<?= base_url('panel-admin/perangkatdesa/save') ?>" enctype="multipart/form-data">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img id="preview" src="https://barurejo.desa.id/assets/images/pengguna/kuser.png" alt="" class="img-thumbnail mx-auto d-block w-25 m-3">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="basic-default-company">NIPD</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="basic-default-company" name="nipd" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="basic-default-company">Nama Lengkap</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="basic-default-company" name="nama_lengkap" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="basic-default-company">Jabatan</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="basic-default-company" name="jabatan" required>
                        </div>
                    </div>
