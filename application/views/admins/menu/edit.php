...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-4">
        ...
        <div class="card-body row justify-content-center">
            <div class="col-sm-6 ">
                <form method="post" action="<?=base_url('panel-admin/menu/update/'.$menu->id_menu)?>">
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="basic-default-name">Nama Menu</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="basic-default-name" name="nama_menu" value="<?=$menu->nama_menu?>" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input name="dinamic_pages" <?=$menu->dinamic_pages == 'Y' ? 'checked':''?> class="form-check-input" type="radio" value="Y" id="defaultRadio1" required>
                                <label class="form-check-label" for="defaultRadio1"> Yes </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-check">
                                <input name="dinamic_pages" <?=$menu->dinamic_pages == 'N' ? 'checked':''?> class="form-check-input" type="radio" value="N" id="defaultRadio1" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="basic-default-company" name="link_menu" value="<?=$menu->link_menu?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="basic-default-company">Urutan Menu</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="basic-default-company" name="urut" required value="<?=$menu->urut?>">
                        </div>
                    </div>
